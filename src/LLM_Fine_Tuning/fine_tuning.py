...
def run(cfg):
    ...
    # wandb 초기화
    # wandb api key 입력
    wandb.login(key='9eb328734e3d984bba20a25815a11f0b5d63448d')
    project_name = cfg.model.split('/')[1] + '-' + 'fine_Tuning'
    wandb.init(project=project_name, config=OmegaConf.to_container(cfg, resolve=True))

    checkpoint_path = "../checkpoints" + '/' + cfg.model.split('/')[1] + '/' + 'fine_tuning'
